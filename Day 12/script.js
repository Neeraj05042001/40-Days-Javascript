...
// for ... in  loop to iterate inside the object
...
console.log(Object.keys(profile)); //object key() method

console.log(profile.salary); // undefined

console.log("salary" in profile); // right way to check either salary exist or not using the "in" operator
